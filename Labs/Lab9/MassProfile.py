...
# Mass Profiles
# G. Besla & H. Foote
# Modified for CenterOfMass2 : volDec
...
from CenterOfMass2 import CenterOfMass # Using modified CenterOfMass
...
class MassProfile:
    ...
    def massEnclosed(self, ptype, radii):
        ...
        com_pos = com.COM_P(0.1,2) # Using modified center of mass
